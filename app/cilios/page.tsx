...
export default function CiliosPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/cilios/book", {
        method: "POST",
    ...
    return (
      <main className="flex flex-1 flex-col items-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <Link href="/cilios" className="block text-center text-xs text-vallue-plum-light underline">
  ...
  return (
    <main className="flex flex-1 flex-col items-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <p className="text-sm text-vallue-plum-light mb-8">
          Cílios · sinal de 30% via Pix para confirmar
        </p>
              ...
              <section>
                ...
                {selectedService && (
                  <div className="mt-4 flex justify-between text-sm text-vallue-plum-light">
                    <span>Sinal a pagar (30%)</span>
                    <span className="font-medium text-vallue-plum">
                      {centsToBRL(Math.round(selectedService.price_cents * 0.3))}
                    </span>
                  </div>
                )}
